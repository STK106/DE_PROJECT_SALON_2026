          ...
          <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <form onSubmit={handleSubmit} className="p-6 md:p-8 flex flex-col gap-6">
              ...
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-balance text-sm text-muted-foreground">
                  Sign in to your GlowBook account
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <Button variant="outline" type="button" aria-label="Sign in with Meta">
                    {/* Meta */}
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4">
              ...
              <p className="text-center text-sm text-muted-foreground">
                ...
                <Link to="/register" className="underline underline-offset-4 font-medium text-foreground hover:text-primary">
                  Sign up
                </Link>
              </p>
            </form>
            ...
            <div className="relative hidden md:flex flex-col overflow-hidden select-none">
              ...
              <div className="relative z-10 mt-auto p-6 text-white">
                ...
                <p className="mt-1 text-xs opacity-60">— Rachel Zoe</p>
              </div>
            </div>
